        ...
        <div class="page-header float-left">
            <div class="page-title">
                <ol class="breadcrumb text-left">
                    <li><a href="#">Home</a></li>
                    <li class="active"><a href="#">Manage Schedules</a></li>
                </ol>
            </div>
        </div>
    </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h3><strong class="card-title">Manage Schedules</strong></h3>
                            <div class="form-group mt-4">
                                <button class="btn btn-primary" data-toggle="modal" data-target="#AddRecordsModal">
                        ...
                        <div class="card-body">
                            @foreach ($appointments as $index => $sched)
                                <div class="card mb-3">
                                    <div class="card-header d-flex justify-content-between align-items-center">
                                        <h5 class="mb-0">Appointment #{{ $index + 1 }}</h5>
                                        <div>
                                            <a href="#" class="btn btn-info btn-sm" data-toggle="modal" data-target="#ViewRecordsModal{{ $sched->app_id }}"><i class="fa fa-eye"></i></a>
                                            <a href="#" class="btn btn-success btn-sm" data-toggle="modal" data-target="#EditRecordsModal{{ $sched->app_id }}"><i class="fa fa-edit"></i></a>
                                            <a class="btn btn-danger btn-sm" data-toggle="modal" data-target="#DeleteRecordsModal{{ $sched->app_id }}"><i class="fa fa-trash"></i></a>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <ul class="list-group">
                                            <li class="list-group-item"><strong>Client:</strong> {{ $sched->full_name }}</li>
                                            <li class="list-group-item"><strong>Phone:</strong> {{ $sched->app_phone }}</li>
                                            <li class="list-group-item"><strong>Conditions:</strong> {{ $sched->app_medical_conditions }}</li>
                                            <li class="list-group-item"><strong>Preferred Time:</strong> {{ $sched->app_preferred_time }}</li>
                                            <li class="list-group-item"><strong>Appointment Date:</strong> {{ \Carbon\Carbon::parse($sched->app_appointment_date)->format('F d, Y H:i') }}</li>
